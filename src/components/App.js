...
class App extends Component{
    ...
    render(){      
        const handleSubmit = (event) =>{  
            ...
            {
                sumOflength == 1 ? result.innerHTML = "Friends" : 
                sumOflength == 2 ? result.innerHTML = "Love" : 
                sumOflength == 3 ? result.innerHTML = "Affection" : 
                sumOflength == 4 ? result.innerHTML = "Marriage" : 
                sumOflength == 5 ? result.innerHTML = "Enemy" : 
                sumOflength == 0 ? result.innerHTML = "Siblings" : null
            };      
        }
